          ...
          <ul class="list-unstyled">
            ...
            try
            {
              ...
              while($resultat = $requete->fetch())
              {
                ...
                if($aime == FALSE) echo '<a href="aime_emploi.php?data='.$id_publication.'"><button type="button" class="btn btn-primary option_publier col-sm-4"><span class="glyphicon glyphicon-heart-empty"></span></button></a>';
                else echo '<a href="aime_plus_emploi.php?data='.$id_publication.'"><button type="button" class="btn btn-primary option_publier col-sm-4"><span class="glyphicon glyphicon-heart"></span></button></a>';
                echo '
